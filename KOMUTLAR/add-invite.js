...
module.exports.run = async (bot, message, args) => {
  ...
  if (!l && !i) {
    return message.channel.send(
      new Discord.RichEmbed()
        ...
        .setDescription("Kime Davet Eklenecek Yazmalısın!")
        .setColor("BLUE")
        .setTitle("UYARI")
        .setTimestamp()
        .setFooter(bot.user.username, bot.user.avatarURL)
  ...
  if (!m) {
    return message.channel.send(
      new Discord.RichEmbed()
        ...
        .setDescription("Kaç Davet Eklenecek Yazmalısın!")
        .setColor("BLUE")
        .setTimestamp()
        .setTitle("UYARI")
        .setFooter(bot.user.username, bot.user.avatarURL)
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setDescription(
      `${kişi} İsimli Kişiye **${m}** Davet Eklendi Toplam Daveti **${davet}**`
    );
  message.channel.send(embed);
...
module.exports.conf = {
  aliases: ["davetekle", "addinvite", "addinvites", "addInvites"],
  permLevel: 0,
  enabled: true,
  guildOnly: true,
  kategori: "moderasyon"
